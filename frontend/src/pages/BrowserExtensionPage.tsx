  ...
  return (
    <Stack gap="6">
      ...
      <Stack as="form" bg="bg.panel" borderColor="border" borderRadius="xl" borderWidth="1px" gap="4" p={{ base: '5', md: '8' }} onSubmit={submit}>
        ...
        <Button alignSelf="start" colorPalette="brand" loading={createToken.isPending} type="submit">Create token</Button>
