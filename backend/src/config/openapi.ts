...
export const openApiDocument: OpenAPIV3.Document = {
  ...
  paths: {
    ...
    "/api/gmail/status": { get: { tags: ["Gmail"], summary: "Get Gmail connection status", description: "Indicates whether Gmail is connected and when the last manual synchronization completed.", security: [{ sessionCookie: [] }], responses: { "200": { description: "Gmail status." } } } },
